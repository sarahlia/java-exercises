...
//        System.out.println("deluxe.getName() = " + deluxe.getName());
//        System.out.println("deluxe.getBreadType() = " + deluxe.getBreadType());
//        System.out.println("deluxe.getMeat() = " + deluxe.getMeat());
//        System.out.println("deluxe.basePrice() = " + deluxe.basePrice());
        deluxe.addAddition3("astor", 2.00);
        deluxe.grandTotal();
